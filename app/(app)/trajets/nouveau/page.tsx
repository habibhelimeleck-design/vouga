...
import { TripForm } from '@/components/trajets/TripForm'
  ...
  return (
    <PageShell>
      ...
      {!isVerified ? (
        <div className="flex flex-col items-center text-center py-12 px-4 gap-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted max-w-[280px] text-balance">
              Vous devez faire vérifier votre identité avant de pouvoir publier un trajet.
            </p>
        ...
        <TripForm defaultWhatsapp={profile?.whatsapp ?? ''} />
      )}
    </PageShell>
  )
}
