...
export function BottomNav() {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-0 inset-x-0 z-40 pb-safe glass-bottom-bar border-t border-[rgba(240,234,224,0.08)]"
          ...
          return (
            <li key={href} className="flex-1">
              ...
              >
                ...
                {active && (
                  <span className="absolute inset-x-2 inset-y-1.5 rounded-[var(--radius-md)] bg-accent/8" aria-hidden />
                )}
